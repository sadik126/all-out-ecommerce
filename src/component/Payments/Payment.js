    ...
    return (
        <div>
            ...
            <div className='p-10'>
                ...
                <p className="text-xl">Please pay <strong>${orders.price}</strong> for the amount of  {orders.products.map(single => <span class="badge text-bg-primary text-danger"  >{single.name}(Quantity:{single.quantity})</span>)}</p>
